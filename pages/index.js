				...
				<div>
					<div className='w-screen md:h-32 h-fit bg-[#252E3F] flex items-center justify-center md:flex-row flex-col'>
						...
						<button className='rounded-3xl w-60 md:w-40 h-16 bg-blue-400 md:ml-32 my-6' >
							<a  href="https://app.0xwait.com/" className='text-xl'> $WAIT dApp </a>
						</button>					</div>
					<div className='w-full bg-[#00e7fa] flex justify-center items-center '>
						<a className="w-3/5 text-[#252e3f] text-2xl font-sans font-bold mx-20 my-6 text-center">Checking the database within this demo does not allow you to claim or update the blockchain, it simply checks if you have sacrificed and how much $WAIT you have available. To claim, use the $WAIT dApp!</a>
					</div>
